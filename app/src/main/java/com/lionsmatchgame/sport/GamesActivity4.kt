...
import kotlinx.android.synthetic.main.activity_games4.*
import java.util.*
import kotlin.random.Random
import kotlin.random.nextInt

class GamesActivity4 : AppCompatActivity() {

    var arrayImage = arrayListOf(R.drawable.image1,R.drawable.image2,R.drawable.image3,R.drawable.image4)

    var arrayImage2 = arrayListOf(R.drawable.image1,R.drawable.image2,R.drawable.image3,R.drawable.image4)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_games4)
